...
run_exp() {
  ...
  if [ "$RC" -ne 0 ]; then
    echo "FAILED $NAME, stop queue"
    exit "$RC"
  fi
}
run_exp D_egms_boundary_full_e160_b13 UKAN_EGMS BoundaryBCEDiceLoss 30701
run_exp C_egms_bcedice_e160_b13 UKAN_EGMS BCEDiceLoss 30702
run_exp B_msag_bcedice_e160_b13 UKAN_MSAG BCEDiceLoss 30703
run_exp A_ukan_bcedice_base_e160_b13 UKAN BCEDiceLoss 30704
